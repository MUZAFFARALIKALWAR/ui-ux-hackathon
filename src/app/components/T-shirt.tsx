...
export default function T_hirt(){
    return(
       <main className="flex justify-center space-x-4 items-start mt-8">
          {/* left side */}
         <div className="flex h-full space-y-4 sm:flex-col">
            <div className="w-[140px] h-[150px]  flex justify-center rounded-[16px]">
